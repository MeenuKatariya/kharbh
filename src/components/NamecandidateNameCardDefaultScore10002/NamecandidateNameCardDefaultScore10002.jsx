...
export const NamecandidateNameCardDefaultScore10002 = ({
  className,
  ...
  return (
    <div className={`namecandidate-name-card-default-score-1000-2 ${className}`}>
      <CtaCardDefaultWrapper
        ...
        text="Modular Operating Theater (OT)"
      />
    </div>
  );
};
